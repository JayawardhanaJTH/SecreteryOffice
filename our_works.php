    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 mb-2">
                <div>
                    <img src="images/our_works/Activation of 5S.jpeg" alt="Activation of 5S">
                </div>
                <div class="text-center">
                    <span class="text-muted h4"><i>Activation of 5S</i></span>
                </div>
            </div>
            ...
            <div class="col-md-6 mb-2">
                <div>
                    <img src="images/our_works/Cultivation Project.jpeg" alt="Cultivation Project">
                </div>
                <div class="text-center">
                    <span class="text-muted h4"><i>Cultivation Project</i></span>
                </div>
            </div>
            <div class="col-md-6 mb-2">
                <div>
