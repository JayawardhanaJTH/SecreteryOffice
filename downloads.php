    ...
    <div class="container border p-1 mb-2">
        ...
        <form action="php/downloads_add.php" method="POST" enctype="multipart/form-data" class="m-1" onsubmit="return validateForm_down()">
            ...
            <div class="form-group">
                ...
                <input type="text" name="fileDescription" id="fileDescription" class="form-control" value="<?php if(isset($fileEdit)){ echo $fileEdit['description'];}?>">
            </div>
            <div class="form-group">
                <label for="file">File</label>
                <input type="file" name="file" id="file" class="form-control" value="<?php if(isset($fileEdit)){ echo $fileEdit['upload_Name'];}?>">
            </div>
